 ...
 * @param teamName - Optional team name (defaults to ASTRONCODE_TEAM_NAME env var or 'default')
 */
...
export type SandboxPermissionRequestMessage = {
  ...
  requestId: string
  /** Worker's ASTRONCODE_AGENT_ID */
  workerId: string
  /** Worker's ASTRONCODE_AGENT_NAME */
  workerName: string
  /** Worker's ASTRONCODE_AGENT_COLOR */
  workerColor?: string
 ...
 * @param teamName - Optional team name (defaults to ASTRONCODE_TEAM_NAME env var)
