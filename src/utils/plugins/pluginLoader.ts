 ...
 *
 * This module is responsible for discovering, loading, and validating Astroncode plugins
...
async function installFromGitHub(
  ...
  const gitUrl = isEnvTruthy(process.env.ASTRONCODE_REMOTE)
 ...
 * ASTRONCODE_REMOTE) or any URL that passes validateGitUrl (https, http,
 * file, git@ ssh).
 */
 ...
 *
 * ASTRONCODE_SYNC_PLUGIN_INSTALL=1 delegates to the full loader — that
