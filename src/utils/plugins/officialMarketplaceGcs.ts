...
const GCS_BASE =
  'https://downloads.claude.ai/astroncode-releases/plugins/astron-plugins-official'

// Zip arc paths are seed-dir-relative (marketplaces/astron-plugins-official/…)
// so the titanium seed machinery can use the same zip. Strip this prefix when
// extracting for a laptop install.
const ARC_PREFIX = 'marketplaces/astron-plugins-official/'
