 ...
 *
 * These helpers identify whether this Astroncode instance is running as a
...
export function isPlanModeRequired(): boolean {
  ...
  return isEnvTruthy(process.env.ASTRONCODE_PLAN_MODE_REQUIRED)
}
 ...
 * 2. Either:
 *    - Our ASTRONCODE_AGENT_ID matches the leadAgentId, OR
 *    - We have no ASTRONCODE_AGENT_ID set (backwards compat: the original
