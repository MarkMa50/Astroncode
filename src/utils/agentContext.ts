 ...
 * variables instead: ASTRONCODE_AGENT_ID, ASTRONCODE_PARENT_SESSION_ID
 *
...
export type SubagentContext = {
  ...
  agentId: string
  /** The team lead's session ID (from ASTRONCODE_PARENT_SESSION_ID env var), undefined for main REPL subagents */
