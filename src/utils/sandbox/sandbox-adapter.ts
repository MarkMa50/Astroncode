...
/**
 * Resolve Astroncode-specific path patterns for sandbox-runtime.
 *
 * Astroncode uses special path prefixes in permission rules:
...
/**
 * Convert Astroncode settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Astroncode started)
...
// scrubbed if they appear after a sandboxed command. See anthropics/astroncode#29316.
 ...
 * bareGitRepoFiles. anthropics/astroncode#29316.
 */
