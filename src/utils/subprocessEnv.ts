...
const GHA_SUBPROCESS_SCRUB = [
  ...
  // astroncode-action-specific duplicates — action JS consumes these during
 ...
 * servers, shell hooks).
 *
 * Gated on ASTRONCODE_SUBPROCESS_ENV_SCRUB. astroncode-action sets this
...
export function subprocessEnv(): NodeJS.ProcessEnv {
  ...
  if (!isEnvTruthy(process.env.ASTRONCODE_SUBPROCESS_ENV_SCRUB)) {
