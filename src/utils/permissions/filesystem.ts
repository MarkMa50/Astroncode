...
// Always ask when Astroncode tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Astroncode for all temp files.
 *
...
// and per-turn from BashTool prompt. Inputs (ASTRONCODE_TMPDIR env + platform) are
 ...
 * - MCP CLI state files (managed internally by Astroncode)
