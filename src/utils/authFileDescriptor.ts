 ...
 * rationale. Env var: ASTRONCODE_OAUTH_TOKEN_FILE_DESCRIPTOR.
...
export function getOAuthTokenFromFileDescriptor(): string | null {
  return getCredentialFromFd({
    envVar: 'ASTRONCODE_OAUTH_TOKEN_FILE_DESCRIPTOR',
