 ...
 *
 * When ASTRONCODE_PROVIDER_MANAGED_BY_HOST is truthy in the spawn env, these
...
const PROVIDER_MANAGED_ENV_VARS = new Set([
  ...
  'ASTRONCODE_PROVIDER_MANAGED_BY_HOST',
  // Provider selection
  ...
  'ASTRONCODE_SKIP_BEDROCK_AUTH',
  'ASTRONCODE_SKIP_VERTEX_AUTH',
  'ASTRONCODE_SKIP_FOUNDRY_AUTH',
 ...
 * These are Astroncode specific settings that don't pose security risks.
 *
...
export const SAFE_ENV_VARS = new Set([
  ...
  'ASTRONCODE_API_KEY_HELPER_TTL_MS',
  'ASTRONCODE_DISABLE_EXPERIMENTAL_BETAS',
  'ASTRONCODE_DISABLE_NONESSENTIAL_TRAFFIC',
  'ASTRONCODE_DISABLE_TERMINAL_TITLE',
  'ASTRONCODE_ENABLE_TELEMETRY',
  'ASTRONCODE_EXPERIMENTAL_AGENT_TEAMS',
  'ASTRONCODE_IDE_SKIP_AUTO_INSTALL',
