...
export type Theme = {
  ...
  bashBorder: string
  astron: string
  astronShimmer: string // Lighter version of astron color for shimmer effect
  astronBlue_FOR_SYSTEM_SPINNER: string
  astronBlueShimmer_FOR_SYSTEM_SPINNER: string
  permission: string
...
const lightTheme: Theme = {
  ...
  astron: 'rgb(96,120,255)', // Astroncode neon blue
  astronShimmer: 'rgb(156,170,255)', // Lighter neon blue for shimmer effect
  astronBlue_FOR_SYSTEM_SPINNER: 'rgb(87,105,247)', // Medium blue for system spinner
  astronBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(117,135,255)', // Lighter blue for system spinner shimmer
  ...
  briefLabelClaude: 'rgb(186,120,255)', // Brand violet
...
const lightAnsiTheme: Theme = {
  ...
  astron: 'ansi:blueBright',
  astronShimmer: 'ansi:cyanBright',
  astronBlue_FOR_SYSTEM_SPINNER: 'ansi:blue',
  astronBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const darkAnsiTheme: Theme = {
  ...
  astron: 'ansi:blueBright',
  astronShimmer: 'ansi:cyanBright',
  astronBlue_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
  astronBlueShimmer_FOR_SYSTEM_SPINNER: 'ansi:blueBright',
...
const lightDaltonizedTheme: Theme = {
  ...
  astron: 'rgb(96,120,255)', // Astroncode neon blue
  astronShimmer: 'rgb(156,170,255)', // Lighter neon blue for shimmer effect
  astronBlue_FOR_SYSTEM_SPINNER: 'rgb(51,102,255)', // Bright blue for system spinner
  astronBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(101,152,255)', // Lighter bright blue for system spinner shimmer
  ...
  fastModeShimmer: 'rgb(255,150,50)', // Lighter orange for shimmer
  briefLabelYou: 'rgb(37,99,235)', // Blue
  briefLabelClaude: 'rgb(186,120,255)', // Brand violet (matches clawd_body)
  rainbow_red: 'rgb(235,95,87)',
  rainbow_orange: 'rgb(245,139,87)',
  rainbow_yellow: 'rgb(250,195,95)',
  rainbow_green: 'rgb(145,200,130)',
...
const darkTheme: Theme = {
  ...
  astron: 'rgb(96,120,255)', // Astroncode neon blue
  astronShimmer: 'rgb(156,170,255)', // Lighter neon blue for shimmer effect
  astronBlue_FOR_SYSTEM_SPINNER: 'rgb(147,165,255)', // Blue for system spinner
  astronBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(177,195,255)', // Lighter blue for system spinner shimmer
...
const darkDaltonizedTheme: Theme = {
  ...
  astron: 'rgb(96,120,255)', // Astroncode neon blue
  astronShimmer: 'rgb(156,170,255)', // Lighter neon blue for shimmer effect
  astronBlue_FOR_SYSTEM_SPINNER: 'rgb(153,204,255)', // Light blue for system spinner
  astronBlueShimmer_FOR_SYSTEM_SPINNER: 'rgb(183,224,255)', // Lighter blue for system spinner shimmer
