...
const TEAMMATE_ENV_VARS = [
  ...
  'ASTRONCODE_USE_BEDROCK',
  'ASTRONCODE_USE_VERTEX',
  'ASTRONCODE_USE_FOUNDRY',
  // Custom API endpoint
  'ANTHROPIC_BASE_URL',
 ...
 * Always includes CLAUDECODE=1 and ASTRONCODE_EXPERIMENTAL_AGENT_TEAMS=1,
 * plus any provider/config env vars that are set in the current process.
 */
export function buildInheritedEnvVars(): string {
  const envVars = ['CLAUDECODE=1', 'ASTRONCODE_EXPERIMENTAL_AGENT_TEAMS=1']
