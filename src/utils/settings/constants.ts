...
/**
 * The JSON Schema URL for Astroncode settings
 * You can edit the contents at https://github.com/SchemaStore/schemastore/blob/master/src/schemas/json/astroncode-settings.json
 */
export const ASTRONCODE_SETTINGS_SCHEMA_URL =
  'https://json.schemastore.org/astroncode-settings.json'
