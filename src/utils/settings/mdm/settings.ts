/**
 * MDM (Mobile Device Management) profile enforcement for Astroncode managed settings.
 *
 ...
 * - Linux: No MDM equivalent (uses /etc/astroncode/managed-settings.json instead)
 *
