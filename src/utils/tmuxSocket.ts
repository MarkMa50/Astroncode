...
async function doInitialize(): Promise<void> {
  ...
  // Pass ASTRONCODE_SKIP_PROMPT_HISTORY via -e so it's set in the initial shell environment
  //
  ...
  const result = await execTmux([
    ...
    'base',
    '-e',
    'ASTRONCODE_SKIP_PROMPT_HISTORY=true',
    ...(getPlatform() === 'windows'
  ...
  // Set ASTRONCODE_SKIP_PROMPT_HISTORY in the tmux GLOBAL environment (-g).
  ...
  // Any Astroncode instance spawned on this socket will inherit this env var,
  ...
  await execTmux([
    ...
    'set-environment',
    '-g',
    'ASTRONCODE_SKIP_PROMPT_HISTORY',
    'true',
  ])
