...
export function getAgentModel(
  ...
  if (process.env.ASTRONCODE_SUBAGENT_MODEL) {
    return parseUserSpecifiedModel(process.env.ASTRONCODE_SUBAGENT_MODEL)
  }
 ...
 * See https://github.com/anthropics/astroncode/issues/30815.
 *
