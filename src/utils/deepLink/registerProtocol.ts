...
export const MACOS_BUNDLE_ID = 'com.anthropic.astroncode-url-handler'
const APP_NAME = 'Astroncode URL Handler'
const DESKTOP_FILE_NAME = 'astroncode-url-handler.desktop'
const MACOS_APP_NAME = 'Astroncode URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Astroncode Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Astroncode
