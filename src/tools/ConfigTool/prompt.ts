...
export const DESCRIPTION = 'Get or set Astroncode configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Astroncode configuration settings.

  View or change Astroncode settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
