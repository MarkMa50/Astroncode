 ...
 * ASTRONCODE_DISABLE_NONESSENTIAL_TRAFFIC are set; a `false` default would
 ...
 *
 * `ASTRONCODE_DISABLE_CRON` is a local override that wins over GB.
 */
export function isKairosCronEnabled(): boolean {
  return feature('AGENT_TRIGGERS')
    ? !isEnvTruthy(process.env.ASTRONCODE_DISABLE_CRON) &&
 ...
 * durable cron. Does NOT consult ASTRONCODE_DISABLE_CRON (that kills the whole
