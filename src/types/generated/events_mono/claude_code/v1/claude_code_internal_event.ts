...
//   protoc               unknown
// source: events_mono/astroncode/v1/astroncode_internal_event.proto
...
export interface EnvironmentMetadata {
  ...
  is_astroncode_action?: boolean | undefined
  ...
  is_astroncode_remote?: boolean | undefined
  remote_environment_type?: string | undefined
  astroncode_container_id?: string | undefined
  astroncode_remote_session_id?: string | undefined
...
/**
 * ClaudeCodeInternalEvent represents events logged from Astroncode via Statsig
...
function createBaseEnvironmentMetadata(): EnvironmentMetadata {
  return {
    ...
    arch: '',
    is_astroncode_remote: false,
    remote_environment_type: '',
    astroncode_container_id: '',
    astroncode_remote_session_id: '',
    tags: [],
...
export const EnvironmentMetadata: MessageFns<EnvironmentMetadata> = {
  fromJSON(object: any): EnvironmentMetadata {
    return {
      ...
      is_github_action: isSet(object.is_github_action)
        ...
        : false,
      is_astroncode_action: isSet(object.is_astroncode_action)
        ? globalThis.Boolean(object.is_astroncode_action)
        : false,
      ...
      is_astroncode_remote: isSet(object.is_astroncode_remote)
        ? globalThis.Boolean(object.is_astroncode_remote)
        : false,
      remote_environment_type: isSet(object.remote_environment_type)
        ? globalThis.String(object.remote_environment_type)
        : '',
      astroncode_container_id: isSet(object.astroncode_container_id)
        ? globalThis.String(object.astroncode_container_id)
        : '',
      astroncode_remote_session_id: isSet(object.astroncode_remote_session_id)
        ? globalThis.String(object.astroncode_remote_session_id)
        : '',
  ...
  toJSON(message: EnvironmentMetadata): unknown {
    ...
    if (message.is_astroncode_action !== undefined) {
      obj.is_astroncode_action = message.is_astroncode_action
    }
    ...
    if (message.is_astroncode_remote !== undefined) {
      obj.is_astroncode_remote = message.is_astroncode_remote
    }
    if (message.remote_environment_type !== undefined) {
      obj.remote_environment_type = message.remote_environment_type
    }
    if (message.astroncode_container_id !== undefined) {
      obj.astroncode_container_id = message.astroncode_container_id
    }
    if (message.astroncode_remote_session_id !== undefined) {
      obj.astroncode_remote_session_id = message.astroncode_remote_session_id
    }
  ...
  fromPartial<I extends Exact<DeepPartial<EnvironmentMetadata>, I>>(
    ...
    message.is_astroncode_action = object.is_astroncode_action ?? false
    ...
    message.is_astroncode_remote = object.is_astroncode_remote ?? false
    message.remote_environment_type = object.remote_environment_type ?? ''
    message.astroncode_container_id = object.astroncode_container_id ?? ''
    message.astroncode_remote_session_id =
      object.astroncode_remote_session_id ?? ''
