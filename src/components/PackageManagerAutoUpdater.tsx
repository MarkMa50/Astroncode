...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateCommand = packageManager === "homebrew" ? "brew upgrade astroncode" : packageManager === "winget" ? "winget upgrade Astron.Astroncode" : packageManager === "apk" ? "apk upgrade astroncode" : "your package manager update command";
  let t4;
  if ($[3] !== verbose) {
