...
export function WelcomeV2() {
  ...
  if (env.terminal === "Apple_Terminal") {
    let t0;
    if ($[0] !== theme) {
      t0 = <AppleTerminalWelcomeV2 theme={theme} welcomeMessage="Welcome to Atroncode" />;
      $[0] = theme;
      $[1] = t0;
    } else {
      t0 = $[1];
  ...
  if (["light", "light-daltonized", "light-ansi"].includes(theme)) {
    ...
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
      t0 = <Text><Text color="claude">{"Welcome to Atroncode"} </Text><Text dimColor={true}>v{MACRO.VERSION} </Text></Text>;
      t1 = <Text>{"\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026\u2026"}</Text>;
      t2 = <Text>{"                                                          "}</Text>;
      t3 = <Text>{"                 [##]      [##]                           "}</Text>;
      t4 = <Text>{"                     | >_ ATRONCODE shell |             "}</Text>;
      t5 = <Text>{"                     |  pixel terminal   |             "}</Text>;
      t6 = <Text>{"               [######]  [######]                         "}</Text>;
      t7 = <Text>{"                 [##]      [##]                           "}</Text>;
      t8 = <Text>{"                                                          "}</Text>;
      $[2] = t0;
...
function AppleTerminalWelcomeV2(t0) {
  ...
  if (isLightTheme) {
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
      ...
      t5 = <Text>{"                                                          "}</Text>;
      t6 = <Text>{"                 [##]      [##]                           "}</Text>;
      t7 = <Text>{"                     | >_ ATRONCODE shell |             "}</Text>;
      t8 = <Text>{"                     |  pixel terminal   |             "}</Text>;
      t9 = <Text>{"               [######]  [######]                         "}</Text>;
      t10 = <Text>{"                 [##]      [##]                           "}</Text>;
      t11 = <Text>{"                                                          "}</Text>;
      $[5] = t10;
