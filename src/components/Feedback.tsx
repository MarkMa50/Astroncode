...
const GITHUB_ISSUES_REPO_URL = "external" === 'ant' ? 'https://github.com/astron-ai/astron-cli-internal/issues' : 'https://github.com/astron-ai/astroncode/issues';
type Props = {
      ...
      {step === 'consent' && <Box flexDirection="column">
          ...
          <Box marginTop={1}>
            <Text wrap="wrap" dimColor>
              ...
              Astroncode&apos;s functionality (eg. to reduce the risk of bugs
