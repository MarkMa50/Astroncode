...
function getNotificationMessage(toolUseConfirm: ToolUseConfirm): string {
  ...
  if (toolUseConfirm.tool === ExitPlanModeV2Tool) {
    return 'Astroncode needs your approval for the plan';
  }
  if (toolUseConfirm.tool === EnterPlanModeTool) {
    return 'Astroncode wants to enter plan mode';
  }
  if (feature('REVIEW_ARTIFACT') && toolUseConfirm.tool === ReviewArtifactTool) {
    return 'Astroncode needs your approval for a review artifact';
  }
  if (!toolName || toolName.trim() === '') {
    return 'Astroncode needs your attention';
  }
  return `Astroncode needs your permission to use ${toolName}`;
}
