...
// user triggers, so the description carries "Astroncode on the web" + URL.
const CCR_TERMS_URL = 'https://docs.astroncode.dev/astroncode-on-the-web'
...
const ultrareview: Command = {
  type: 'local-jsx',
  name: 'ultrareview',
  description: `~10–20 min · Finds and verifies bugs in your branch. Runs in Astroncode on the web. See ${CCR_TERMS_URL}`,
