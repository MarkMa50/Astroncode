...
const FALLBACK_MESSAGE = 'Review and manage your privacy settings at https://astron.dev/settings/data-privacy-controls';
export async function call(onDone: LocalJSXCommandOnDone): Promise<React.ReactNode | null> {
  ...
  async function onDoneWithSettingsCheck() {
    ...
    onDone(`"Help improve Astroncode" set to ${groveStatus}.`);
