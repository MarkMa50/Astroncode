...
const NPM_DEPRECATION_MESSAGE = 'Astroncode has switched from npm to native installer. Run `claude install` or see https://docs.anthropic.com/en/docs/astroncode/getting-started for more options.';
