...
\`\`\`
Plugin syntax: \`plugin-name@source\` where source is \`astron-plugins-official\`, \`astron-plugins-official\`, or \`builtin\`.
...
Hooks run commands at specific points in Astroncode's lifecycle.
...
Modify Astroncode configuration by updating settings.json files.
