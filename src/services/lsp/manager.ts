 ...
 * Initialized during Astroncode startup.
 */
 ...
 * asynchronously during Astroncode startup. Use getInitializationStatus() to
 ...
 *
 * This function is called during Astroncode startup. It synchronously creates
 ...
 *
 * Fixes https://github.com/anthropics/astroncode/issues/15521:
 ...
 *
 * This should be called during Astroncode shutdown. Stops all running LSP servers
