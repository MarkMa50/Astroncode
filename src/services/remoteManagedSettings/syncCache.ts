 ...
 *   ASTRONCODE_OAUTH_TOKEN / FD, or keychain tokens missing metadata): Eligible —
...
export function isRemoteManagedSettingsEligible(): boolean {
  ...
  // Externally-injected tokens (CCD via ASTRONCODE_OAUTH_TOKEN, CCR via
  // ASTRONCODE_OAUTH_TOKEN_FILE_DESCRIPTOR, Agent SDK, CI) carry no
